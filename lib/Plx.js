...
var Plx = function (_Component) {
  ...
  _createClass(Plx, [{
    ...
    value: function update() {
      ...
      if (newState) {
        var backgroundImage = this.props.style.backgroundImage;
        var _newState$plxStyle = newState.plxStyle,
            transform = _newState$plxStyle.transform,
            opacity = _newState$plxStyle.opacity;
